...
class pluginHumanstxt extends Plugin {
	...
	public function form()
	{
        ...
        $html .= '<div class="modal fade" id="donateHumantxtModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">' . $L->get('ld-donate-title') . '</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"><p><img src="' . DOMAIN_PLUGINS . 'humanstxt/img/qr.png" alt="" class="mx-auto d-block img-fluid" /></p><p><br>' . $L->get('ld-donate-text') . '</p><p>BTC: <code><a href="bitcoin:39xYc2jxrxFMiWgWDw7RYUmyF7vF331QWX">39xYc2jxrxFMiWgWDw7RYUmyF7vF331QWX</a></code></p></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-dismiss="modal">' . $L->get('ld-close') . '</button></div></div></div></div>';
